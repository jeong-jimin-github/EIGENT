...
// Key traits:
//   - Neutral (cool) grays
//   - EIGENT Blue accent (#05bdf5 base, oklch 228.71 hue)
...
export const cortexTheme: ThemeDefinition = {
	id: "cortex",
	name: "Cortex",
	description: "Cool neutrals with EIGENT Blue accent, clean and minimal",
	cssVars: {
		light: {
...
//     EIGENT Blue fallbacks, so they track the OS accent color
