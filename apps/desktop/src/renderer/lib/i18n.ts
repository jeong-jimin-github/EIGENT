...
const en = {
	...
	"sidebar.projectTools": "Project tools", "sidebar.closeProjectTools": "Close project tools", "sidebar.loadingSessions": "Loading sessions...", "sidebar.noSessions": "No sessions yet",
	...
	"project.createTitle": "Create Project", "project.createDescription": "Enter a project name. EIGENT will create the folder automatically in its default workspace location.",
	"project.name": "Project Name", "project.nameHint": "Use a folder name only; no absolute path is needed.",
	"project.create": "Create Project",
	"project.addTitle": "Add Remote Project", "project.addDescription": "Enter the absolute path to a project directory available to this remote OpenCode server.",
	"project.path": "Directory Path", "project.pathHint": "The directory must already exist on the remote server.",
	"project.add": "Add Project", "project.addFailed": "Failed to add project. Check the name or path and access permissions.",
	...
	"settings.default": "Default", "settings.fullThinking": "Full thinking", "settings.verbose": "Verbose", "settings.openDestination": "Default open destination",
...
const ko: Record<TranslationKey, string> = {
	...
	"sidebar.projectTools": "프로젝트 도구", "sidebar.closeProjectTools": "프로젝트 도구 닫기", "sidebar.loadingSessions": "세션 불러오는 중...", "sidebar.noSessions": "세션이 없습니다",
	...
	"project.createTitle": "프로젝트 생성", "project.createDescription": "프로젝트 이름만 입력하세요. EIGENT가 기본 작업공간에 폴더를 자동으로 생성합니다.",
	"project.name": "프로젝트 이름", "project.nameHint": "폴더 이름만 입력하면 되며 절대 경로는 필요하지 않습니다.",
	"project.create": "프로젝트 생성",
	"project.addTitle": "원격 프로젝트 추가", "project.addDescription": "원격 OpenCode 서버에서 접근 가능한 프로젝트의 절대 경로를 입력하세요.",
	"project.path": "디렉터리 경로", "project.pathHint": "원격 서버에 이미 존재하는 디렉터리여야 합니다.",
	"project.add": "프로젝트 추가", "project.addFailed": "프로젝트를 추가하지 못했습니다. 이름 또는 경로와 접근 권한을 확인하세요.",
	...
	"settings.default": "기본", "settings.fullThinking": "생각 전체", "settings.verbose": "상세", "settings.openDestination": "기본 열기 위치",
